...
fix(data)
attach(data)
# Question 1: Calculate the population mean and population standard deviation of the laptop bag weights.
...
#Question 2: Draw 25 random samples of size 6 (with replacement) and calculate the sample mean and sample standard deviation for each sample. Create a null matrix to store sample data sets.
samples<-c()
n_samples <- 25
sample_size <- 6
...
# Question 3: Calculate the mean and standard deviation of the 25 sample means and state the relationship of them with true mean and true standard deviation.
